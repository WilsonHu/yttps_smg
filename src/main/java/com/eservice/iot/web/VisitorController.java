...
public class VisitorController {
    ...
    @PostMapping("/add")
    public Result add(@RequestBody String jsonData) {
        ...
        if (responseEntity.getStatusCodeValue() == ResponseCode.OK) {
            ...
            if (body != null) {
                ...
                if (responseModel != null && responseModel.getResult() != null) {
                    ...
                    return ResultGenerator.genFailResult(body);
                }
            }
        }
...
//                        }
    ...
    @PostMapping("/accept")
    public Result accept(@RequestParam String visitorId) {
        List<Visitor> visitorList = visitorService.getVisitorList();
        Visitor visitor = null;
        for (int i = 0; i < visitorList.size() && visitor == null; i++) {
            if (visitorList.get(i).getVisitor_id().equals(visitorId)) {
    ...
    public Result list() {
        if (visitorService != null) {
            return ResultGenerator.genSuccessResult(visitorService.getVisitorList());
        } else {
